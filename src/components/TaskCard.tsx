  ...
  const backgroundColors =
    task.status === 'done'
      ...
      : {
          ...
          medium:
            'bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 hover:from-amber-100 hover:to-amber-200',
      ...
      >
        ...
        {task.dueDate && (
          <div className="mt-2 text-sm flex items-center gap-1">
            <svg
              className={`w-4 h-4 ${getDueDateUrgency(task.dueDate) === 'normal' ? 'text-gray-500' : 'text-amber-500'}`}
              fill="none"
              strokeWidth="2"
              stroke="currentColor"
              viewBox="0 0 24 24"
